...
// ========= Hàm liên quan tới danh sách sản phẩm =========
...
function logIn(form) {
    ...
    // Kiểm tra khớp dữ liệu người dùng
    ...
    for (var ad of adminInfo) {
        if (equalUser(newUser, ad)) {
            alert('Hello Hung, have a good day ');
...
function signUp(form) {
    ...
    // Lấy dữ liệu các khách hàng đang có
    var listUser = getListUser();

    // Kiểm tra trùng tài khoản admin
    for (var ad of adminInfo) {
    ...
    // Kiểm tra trùng tài khoản khách
    for (var u of listUser) {
    ...
    alert('Đăng kí thành công, chúc bạn mua sắm vui vẻ!.');
    location.reload();
...
// Check xem có ai đăng nhập hay chưa (CurrentUser)
// chạy khi ấn vào nút tài khoản trên bar
...
// lấy số lương sản phẩm của một user được truyền vào
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        ...
                        <a onclick="if(window.confirm('Bạn muốn đăng xuất ?')) logOut();">Đăng xuất</a>
                    </div>
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giao hàng ở khu vực nội thành trong vòng 2 giờ</li>
                <li>Thanh toán linh hoạt: tiền mặt, thẻ tín dụng, trả góp</li>
                <li>Trải nghiệm sản phẩm tại nhà</li>
                <li>Lỗi sản phẩm hỗ trợ 1 đổi 1</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:012345678" style="color: #288ad6;">1234.5678</a>
                </li>
            </ul>
        </section>
    </div>`);
...
function checkLocalStorage() {
    if (typeof (Storage) == "undefined") {
        alert('Máy không hỗ trợ LocalStorage. Không thể lưu thông tin sản phẩm, rất xin lỗi bạn!.');
    } else {
        console.log('Lưu trên LocaStorage thành công!');
    }
}
